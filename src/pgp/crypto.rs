...
use crate::pgp::types::SignatureBytes;
...
pub trait Decryptor {
    ...
    fn decrypt(&self, data: Self::EncryptionFields<'_>) -> crate::pgp::errors::Result<Vec<u8>>;
}

/// Describes keys that can sign data.
pub trait Signer {
    fn sign(&self, hash: HashAlgorithm, digest: &[u8]) -> crate::pgp::errors::Result<SignatureBytes>;
}
