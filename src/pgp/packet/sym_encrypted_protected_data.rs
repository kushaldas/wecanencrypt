...
impl SymEncryptedProtectedData {
    ...
    pub fn encrypt_seipdv2<R: CryptoRng + Rng>(
        ...
        let mut encryptor = crate::pgp::crypto::aead::StreamEncryptor::new(
            sym_alg,
            aead,
            chunk_size,
            session_key,
...
pub enum StreamDecryptor<R: BufRead> {
    V1(crate::pgp::crypto::sym::StreamDecryptor<R>),
    GnupgAead(crate::pgp::crypto::aead::StreamDecryptor<R>),
    V2(crate::pgp::crypto::aead::StreamDecryptor<R>),
}
...
impl<R: BufRead> StreamDecryptor<R> {
    ...
    pub fn gnupg_aead(
        ...
        let decryptor = crate::pgp::crypto::aead::StreamDecryptor::new_gnupg(
    ...
    pub fn v2(
        ...
        let decryptor = crate::pgp::crypto::aead::StreamDecryptor::new_rfc9580(
